...
FFI_PLUGIN_EXPORT void aes_key_setup(const BYTE key[],          // The key, must be 128, 192, or 256 bits
                   WORD w[],                  // Output key schedule to be used later
                   int keysize);              // Bit length of the key, 128, 192, or 256

FFI_PLUGIN_EXPORT void aes_encrypt(const BYTE in[],             // 16 bytes of plaintext
                 BYTE out[],                  // 16 bytes of ciphertext
                 const WORD key[],            // From the key setup
                 int keysize);                // Bit length of the key, 128, 192, or 256

FFI_PLUGIN_EXPORT void aes_decrypt(const BYTE in[],             // 16 bytes of ciphertext
...
// AES - CBC
///////////////////
FFI_PLUGIN_EXPORT int aes_encrypt_cbc(const BYTE in[],          // Plaintext
...
FFI_PLUGIN_EXPORT int aes_encrypt_cbc_mac(const BYTE in[],      // plaintext
                        size_t in_len,        // Must be a multiple of AES_BLOCK_SIZE
                        BYTE out[],           // Output MAC
                        const WORD key[],     // From the key setup
                        int keysize,          // Bit length of the key, 128, 192, or 256
...
// AES - CTR
///////////////////
FFI_PLUGIN_EXPORT void increment_iv(BYTE iv[],                  // Must be a multiple of AES_BLOCK_SIZE
                  int counter_size);          // Bytes of the IV used for counting (low end)

FFI_PLUGIN_EXPORT void aes_encrypt_ctr(const BYTE in[],         // Plaintext
...
FFI_PLUGIN_EXPORT void aes_decrypt_ctr(const BYTE in[],         // Ciphertext
                     size_t in_len,           // Any byte length
...
FFI_PLUGIN_EXPORT int aes_encrypt_ccm(const BYTE plaintext[],              // IN  - Plaintext.
...
FFI_PLUGIN_EXPORT int aes_decrypt_ccm(const BYTE ciphertext[],             // IN  - Ciphertext, the concatination of encrypted plaintext and MAC.
